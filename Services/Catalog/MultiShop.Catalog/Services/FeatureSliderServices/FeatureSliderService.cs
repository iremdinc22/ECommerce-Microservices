...
public class FeatureSliderService :  IFeatureSliderService
{
    ...
    {
        var values = await _featureSliderCollection.Find<FeatureSlider>(x => x.Status== true).ToListAsync();
    ...
    public async Task UpdateFeatureSliderAsync(UpdateFeatureSliderDto updateFeatureSliderDto)
    {
        ...
        await _featureSliderCollection.FindOneAndReplaceAsync(
            x => x.FeatureSliderId == updateFeatureSliderDto.FeatureSliderId, values);
    }
