...
public class SpecialOfferService : ISpecialOfferService
{
    ...
    {
        var values = await _specialOfferCollection.Find<SpecialOffer>(x => true).ToListAsync();
    ...
    public Task UpdateSpecialOfferAsync(UpdateSpecialOfferDto updateSpecialOfferDto)
    {
        ...
        return _specialOfferCollection.ReplaceOneAsync(x => x.SpecialOfferId == updateSpecialOfferDto.SpecialOfferId, value);
    }
    ...
    public async Task<GetByIdSpecialOfferDto> GetByIdPSpecialOfferAsync(string id)
    {
